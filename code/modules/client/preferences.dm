...
/datum/preferences/proc/SetSpecial(mob/user)
	...
	dat += "<b>Moxy is your personal charisma with npcs and vending machines (don't ask how they know). It adjusts prices from vendors and selling to the scrappers.</a><BR>"
	dat += "<hr>"
